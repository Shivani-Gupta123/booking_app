...
const PropertyList = () => {
  return (
    <div className='pList'>
      ...
      <div className='pListItem'>
        <img src="https://q-xx.bstatic.com/xdata/images/xphoto/300x240/45450074.jpeg?k=7039b03a94f3b99262c4b3054b0edcbbb91e9dade85b6efc880d45288a06c126&o=" alt="" className="pListImg" />
        <div className="pListTitles">
            <h1>Cottages</h1>
            <h2>577345 cottages</h2>
        </div>
      </div>
    </div>
  )
